...
const HeroSection = () => {
  ...
  // Removed GSAP animation to prevent parallax effects
  ...
  return (
    <section ref={heroRef} id="home" className="relative min-h-screen w-full">
      {/* Clean Background */}
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="text-center mb-8 md:mb-12">
            ...
            >
              ...
              <span 
                className="block text-platinum/80 mt-2"
            ...
            <motion.p
              ...
              className="text-platinum/70 mb-8 max-w-3xl mx-auto leading-relaxed"
