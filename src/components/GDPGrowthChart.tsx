...
const CustomTooltip = ({ active, payload, label }: any) => {
  if (active && payload && payload.length) {
    ...
    return (
      <div className="bg-midnight/90 backdrop-blur-sm border border-gold/30 rounded-lg p-3">
    ...
    <section id="growth" className="py-20" style={{ paddingTop: '2em', paddingBottom: '2em' }}>
      <div className="w-full max-w-[100vw] px-[4vw] md:px-[6vw] lg:px-[8vw] mx-auto overflow-x-hidden">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-charcoal/80 backdrop-blur-sm rounded-2xl p-8 border border-gold/20 mb-12"
        >
          <div className="h-96">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <div>
                <div className="text-3xl font-bold text-platinum">₹14 Cr+</div>
                <div className="text-platinum/60">Returns</div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="text-center">
              <div className="text-4xl font-bold text-platinum mb-2">₹14 Cr+</div>
              <div className="text-platinum/60">Recent Project Returns</div>
            </div>
          </motion.div>
        </div>
      </div>
